import numpy as np
import textwrap
#Este código ha sido extraido de https://towardsdatascience.com/how-to-create-and-visualize-complex-radar-charts-f7764d0f3652 y es utilziado para crear radar charts
class ComplexRadar():
    """
    ...
    def _scale_data(self, data, ranges):
        ...
        data_1=[]
        for element in data:
            data_1.append(element[1])
        for d, (y1, y2) in zip(data_1[1:], ranges[1:]):
